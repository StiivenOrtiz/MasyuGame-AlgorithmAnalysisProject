...
def filtrar_multilista(lista, multilista):
    # Función que filtra la multilista para que contenga solo las sublistas que tienen todos los elementos de 'lista'
    resultado = []
    for sublista in multilista:
        if all(elem in sublista for elem in lista):
            resultado.append(sublista)
    return resultado

# Lista y multilista proporcionadas
lista = [(1, 0)]
multilista = [[(2, 1), (0, 1), (0, 2)], [(2, 1), (0, 1), (0, 0)], [(0, 1), (2, 1), (2, 2)], [(0, 1), (2, 1), (2, 0)], [(1, 0), (1, 2), (2, 2)], [(1, 0), (1, 2), (0, 2)], [(1, 2), (1, 0), (2, 0)], [(1, 2), (1, 0), (0, 0)]]

# Llamada a la función y muestra de resultados
resultado = filtrar_multilista(lista, multilista)
print(resultado)
